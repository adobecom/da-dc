export default class PdfReaderPage {
  constructor(page) {
    this.page = page;
    ...
    /** Reader download CTA inside the hero */
    this.heroReaderDownloadLink = this.heroMarquee.locator('a[href*="get.adobe.com"]');

    this.firstThreeUpSection = page.locator('div.section.three-up').first();

    this.splitImageBlock = page.locator('div.image.split-image');

    // Merch — compare Acrobat plans (same fragment stack as Acrobat Pro page)
    ...
    this.acrobatProForStudentsAndTeachersFreeTrial = this.acrobatProForStudentsAndTeachers.locator(
      'a[is*="checkout-link"][data-wcs-osi="WJLr3TF4T4qyJIGZTsDf9KPbTfxA7qAgStpaF2IgYao"]',
    );
    this.acrobatProForStudentsAndTeachersBuyNow = this.acrobatProForStudentsAndTeachers.locator(
      'a[is*="checkout-link"][data-wcs-osi="ZZQMV2cU-SWQoDxuznonUFMRdxSyTr4J3fB77YBNakY"]',
    );
    ...
    this.creativeCloudForStudentsAndTeachersFreeTrial = this.creativeCloudForStudentsAndTeachers.locator(
      'a[is*="checkout-link"][data-wcs-osi="OQ1oCm1tZG35Gj7LCrkGeOOdUMfVlC7xx-7ml-CTWIE"]',
    );
    this.creativeCloudForStudentsAndTeachersBuyNow = this.creativeCloudForStudentsAndTeachers.locator(
      'a[is*="checkout-link"][data-wcs-osi="Hnk2P6L5wYhnpZLFYTW5upuk2Y3AJXlso8VGWQ0l2TI"]',
    );
    ...
    this.systemRequirementsLink = page.locator('a[daa-ll="Tech specs-1--"]');
    this.volumeDistributionLink = page.locator('a[href*="volume-distribution"]');
